...
const BellOutline = memo(props => (<Svg viewBox="0 0 24 24" {...props}>
    <G data-name="Layer 2">
      <Path d="m20.52 15.21-1.8-1.81V8.94a6.86 6.86 0 0 0-5.82-6.88 6.74 6.74 0 0 0-7.62 6.67v4.67l-1.8 1.81A1.64 1.64 0 0 0 4.64 18H8v.34A3.84 3.84 0 0 0 12 22a3.84 3.84 0 0 0 4-3.66V18h3.36a1.64 1.64 0 0 0 1.16-2.79zM14 18.34A1.88 1.88 0 0 1 12 20a1.88 1.88 0 0 1-2-1.66V18h4zM5.51 16l1.18-1.18a2 2 0 0 0 .59-1.42V8.73A4.73 4.73 0 0 1 8.9 5.17 4.67 4.67 0 0 1 12.64 4a4.86 4.86 0 0 1 4.08 4.9v4.5a2 2 0 0 0 .58 1.42L18.49 16z" data-name="bell"/>
    </G>
  </Svg>));
const BellOffOutline = memo(props => (<Svg viewBox="0 0 24 24" {...props}>
    <G data-name="Layer 2">
...
const Checkmark = memo(props => (<Svg viewBox="0 0 24 24" {...props}>
    <G data-name="Layer 2">
...
const Close = memo(props => (<Svg viewBox="0 0 24 24" {...props}>
    <G data-name="Layer 2">
...
const Forward = memo(props => (<Svg viewBox="0 0 24 24" {...props}>
    <G data-name="Layer 2">
      <Path d="M5 13h11.86l-3.63 4.36a1 1 0 0 0 1.54 1.28l5-6a1.19 1.19 0 0 0 .09-.15c0-.05.05-.08.07-.13A1 1 0 0 0 20 12a1 1 0 0 0-.07-.36c0-.05-.05-.08-.07-.13a1.19 1.19 0 0 0-.09-.15l-5-6A1 1 0 0 0 14 5a1 1 0 0 0-.64.23 1 1 0 0 0-.13 1.41L16.86 11H5a1 1 0 0 0 0 2z" data-name="arrow-forward"/>
    </G>
  </Svg>));
const Heart = memo(props => (<Svg viewBox="0 0 24 24" {...props}>
    <G data-name="Layer 2">
      <Path d="M12 21a1 1 0 0 1-.71-.29l-7.77-7.78a5.26 5.26 0 0 1 0-7.4 5.24 5.24 0 0 1 7.4 0L12 6.61l1.08-1.08a5.24 5.24 0 0 1 7.4 0 5.26 5.26 0 0 1 0 7.4l-7.77 7.78A1 1 0 0 1 12 21z" data-name="heart"/>
    </G>
  </Svg>));
const HeartOutline = memo((props) => (<Svg viewBox="0 0 24 24" {...props}>
    <G data-name="Layer 2">
      <Path d="M12 21a1 1 0 0 1-.71-.29l-7.77-7.78a5.26 5.26 0 0 1 0-7.4 5.24 5.24 0 0 1 7.4 0L12 6.61l1.08-1.08a5.24 5.24 0 0 1 7.4 0 5.26 5.26 0 0 1 0 7.4l-7.77 7.78A1 1 0 0 1 12 21zM7.22 6a3.2 3.2 0 0 0-2.28.94 3.24 3.24 0 0 0 0 4.57L12 18.58l7.06-7.07a3.24 3.24 0 0 0 0-4.57 3.32 3.32 0 0 0-4.56 0l-1.79 1.8a1 1 0 0 1-1.42 0L9.5 6.94A3.2 3.2 0 0 0 7.22 6z" data-name="heart"/>
    </G>
  </Svg>));
const Send = memo(props => (<Svg viewBox="0 0 24 24" {...props}>
    <G data-name="Layer 2">
...
const MessageCircleOutline = memo(props => (<Svg viewBox="0 0 24 24" {...props}>
    <G data-name="Layer 2">
...
const MessageSquareOutline = memo(props => (<Svg viewBox="0 0 24 24" {...props}>
    <G data-name="Layer 2">
...
const MoreHorizontal = memo(props => (<Svg viewBox="0 0 24 24" {...props}>
    <G data-name="Layer 2">
...
const MoreVertical = memo(props => (<Svg viewBox="0 0 24 24" {...props}>
    <G data-name="Layer 2">
